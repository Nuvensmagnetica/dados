...
def rotation_matrix_from_axis_and_angle(u, theta):
    '''Calculate a rotation matrix from an axis and an angle In three dimensions (see Wikipedia Rotation Matrix).'''
    '''u:= eixo de rotação; theta:= ângulo de rotação no sentido anti-horário'''
